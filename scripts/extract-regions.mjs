...
const out = {
  _meta: {
    ...
    knownIssues: [
      'Gameplay fields are NOT canonical. Clear example: Erebor is tagged Nation=Sauron / Shadow-controlled, but it is a DWARVEN Stronghold (rulebook p.16). nation/side/control are not to be trusted.',
